...
void NMMainWindow::setupMenuBar() {
  ...
  m_actionOpenProject =
      fileMenu->addAction(iconMgr.getIcon("file-open", 16), tr("&Open Project..."));
  ...
  m_actionSaveProjectAs =
      fileMenu->addAction(iconMgr.getIcon("file-save", 16), tr("Save Project &As..."));
  ...
  m_actionCloseProject =
      fileMenu->addAction(iconMgr.getIcon("file-close", 16), tr("&Close Project"));
  ...
  m_actionValidateProject =
      projectMenu->addAction(iconMgr.getIcon("panel-diagnostics", 16), tr("&Validate Project"));
  m_actionValidateProject->setShortcut(QKeySequence(Qt::CTRL | Qt::SHIFT | Qt::Key_V));
  m_actionValidateProject->setToolTip(tr("Run full project integrity validation"));
  ...
  m_actionToggleSceneView =
      panelsMenu->addAction(iconMgr.getIcon("panel-scene", 16), tr("&Scene View"));
  ...
  m_actionToggleStoryGraph =
      panelsMenu->addAction(iconMgr.getIcon("panel-graph", 16), tr("Story &Graph"));
  ...
  m_actionToggleScriptEditor =
      panelsMenu->addAction(iconMgr.getIcon("panel-console", 16), tr("Script &Editor"));
  ...
  m_actionToggleScriptDocs = panelsMenu->addAction(iconMgr.getIcon("help", 16), tr("Script &Docs"));
  ...
  m_actionToggleInspector =
      panelsMenu->addAction(iconMgr.getIcon("panel-inspector", 16), tr("&Inspector"));
  ...
  m_actionToggleConsole =
      panelsMenu->addAction(iconMgr.getIcon("panel-console", 16), tr("&Console"));
  ...
  m_actionToggleIssues =
      panelsMenu->addAction(iconMgr.getIcon("panel-diagnostics", 16), tr("&Issues"));
  ...
  m_actionToggleDiagnostics =
      panelsMenu->addAction(iconMgr.getIcon("panel-diagnostics", 16), tr("&Diagnostics"));
  ...
  m_actionToggleVoiceStudio =
      panelsMenu->addAction(iconMgr.getIcon("panel-voice", 16), tr("Voice &Studio"));
  ...
  m_actionToggleVoiceManager =
      panelsMenu->addAction(iconMgr.getIcon("panel-voice", 16), tr("Voice &Manager"));
  ...
  m_actionToggleAudioMixer =
      panelsMenu->addAction(iconMgr.getIcon("panel-voice", 16), tr("&Audio Mixer"));
  m_actionToggleAudioMixer->setCheckable(true);
  m_actionToggleAudioMixer->setChecked(true);
  m_actionToggleAudioMixer->setToolTip(tr("Audio Mixer - Control audio levels and mixing"));

  m_actionToggleLocalization =
      panelsMenu->addAction(iconMgr.getIcon("panel-localization", 16), tr("&Localization"));
  ...
  m_actionToggleTimeline =
      panelsMenu->addAction(iconMgr.getIcon("panel-timeline", 16), tr("&Timeline"));
  ...
  m_actionToggleCurveEditor =
      panelsMenu->addAction(iconMgr.getIcon("panel-curve", 16), tr("&Curve Editor"));
  ...
  m_actionToggleBuildSettings =
      panelsMenu->addAction(iconMgr.getIcon("panel-build", 16), tr("&Build Settings"));
  ...
  m_actionToggleAssetBrowser =
      panelsMenu->addAction(iconMgr.getIcon("panel-assets", 16), tr("&Asset Browser"));
  ...
  m_actionToggleScenePalette =
      panelsMenu->addAction(iconMgr.getIcon("panel-scene", 16), tr("Scene &Palette"));
  ...
  m_actionToggleHierarchy =
      panelsMenu->addAction(iconMgr.getIcon("panel-hierarchy", 16), tr("&Hierarchy"));
  ...
  m_actionToggleDebugOverlay =
      panelsMenu->addAction(iconMgr.getIcon("panel-diagnostics", 16), tr("&Debug Overlay"));
  ...
  m_actionFocusMode = viewMenu->addAction(iconMgr.getIcon("panel-scene", 16), tr("&Focus Mode"));
  m_actionFocusMode->setCheckable(true);
  m_actionFocusMode->setToolTip(tr("Focus Scene View with Inspector and Assets"));
  m_actionFocusMode->setShortcut(QKeySequence("F9"));

  m_actionFocusIncludeHierarchy = viewMenu->addAction(tr("Focus Mode: Include &Hierarchy"));
  ...
  m_actionLayoutDefault =
      m_workspaceMenu->addAction(iconMgr.getIcon("panel-scene", 16), tr("&Default"));
  ...
  m_actionLayoutStoryScript =
      m_workspaceMenu->addAction(iconMgr.getIcon("panel-graph", 16), tr("Story / &Script"));
  ...
  m_actionLayoutSceneAnimation =
      m_workspaceMenu->addAction(iconMgr.getIcon("panel-timeline", 16), tr("Scene / &Animation"));
  ...
  m_actionLayoutAudioVoice =
      m_workspaceMenu->addAction(iconMgr.getIcon("panel-voice", 16), tr("&Audio / Voice"));
  ...
  m_actionLayoutStory =
      m_workspaceMenu->addAction(iconMgr.getIcon("panel-graph", 16), tr("Stor&y (Legacy)"));
  m_actionLayoutStory->setToolTip(tr("Story Graph + Inspector + Play + Log"));
  m_actionLayoutStory->setShortcut(QKeySequence("Ctrl+1"));

  m_actionLayoutScene =
      m_workspaceMenu->addAction(iconMgr.getIcon("panel-scene", 16), tr("S&cene (Legacy)"));
  m_actionLayoutScene->setToolTip(tr("Scene View + Assets + Inspector + Hierarchy"));
  m_actionLayoutScene->setShortcut(QKeySequence("Ctrl+2"));

  m_actionLayoutScript =
      m_workspaceMenu->addAction(iconMgr.getIcon("panel-console", 16), tr("Scr&ipt (Legacy)"));
  m_actionLayoutScript->setToolTip(tr("Script Editor + Story Graph + Play"));
  m_actionLayoutScript->setShortcut(QKeySequence("Ctrl+3"));

  m_actionLayoutDeveloper = m_workspaceMenu->addAction(iconMgr.getIcon("panel-diagnostics", 16),
                                                       tr("&Developer (Legacy)"));
  ...
  m_actionLayoutCompact =
      m_workspaceMenu->addAction(iconMgr.getIcon("panel-asset", 16), tr("&Compact (Legacy)"));
  m_actionLayoutCompact->setToolTip(tr("Compact layout with more panels visible at once"));
  ...
  m_workspaceMenu->addSeparator();
  m_actionSaveWorkspaceAs = m_workspaceMenu->addAction(iconMgr.getIcon("file-save", 16),
                                                       tr("Save Current Layout &As..."));
  m_actionSaveWorkspaceAs->setToolTip(
      tr("Save the current panel arrangement as a custom workspace preset"));

  m_actionManageWorkspaces =
      m_workspaceMenu->addAction(iconMgr.getIcon("settings", 16), tr("&Manage Workspaces..."));
  m_actionManageWorkspaces->setToolTip(tr("Rename or delete custom workspace presets"));

  // Connect to populate menu when it's about to be shown
  connect(m_workspaceMenu, &QMenu::aboutToShow, this, &NMMainWindow::populateWorkspaceMenu);

  QMenu* layoutMenu = viewMenu->addMenu(tr("&Layouts"));
  m_actionSaveLayout = layoutMenu->addAction(iconMgr.getIcon("file-save", 16), tr("&Save Layout"));
  m_actionSaveLayout->setToolTip(tr("Save current layout"));
  m_actionLoadLayout = layoutMenu->addAction(iconMgr.getIcon("file-open", 16), tr("&Load Layout"));
  m_actionLoadLayout->setToolTip(tr("Load saved layout"));
  layoutMenu->addSeparator();
  m_actionResetLayout = layoutMenu->addAction(iconMgr.getIcon("refresh", 16), tr("&Reset Layout"));
  m_actionResetLayout->setToolTip(tr("Reset all panels to workspace defaults"));

  layoutMenu->addSeparator();
  m_actionLockLayout = layoutMenu->addAction(iconMgr.getIcon("locked", 16), tr("&Lock Layout"));
  ...
  m_actionSaveState = playMenu->addAction(iconMgr.getIcon("file-save", 16), tr("&Save State"));
  ...
  m_actionLoadState = playMenu->addAction(iconMgr.getIcon("file-open", 16), tr("&Load State"));
  ...
  m_actionAutoSaveState = playMenu->addAction(iconMgr.getIcon("file-save", 16), tr("Auto &Save"));
  m_actionAutoSaveState->setToolTip(tr("Save runtime state to auto-save"));

  m_actionAutoLoadState = playMenu->addAction(iconMgr.getIcon("file-open", 16), tr("Auto &Load"));
  ...
  m_actionHotkeys = helpMenu->addAction(iconMgr.getIcon("help", 16), tr("&Hotkeys && Tips"));
  ...
  m_actionAbout =
      helpMenu->addAction(iconMgr.getIcon("info", 16), tr("&About NovelMind Editor..."));
