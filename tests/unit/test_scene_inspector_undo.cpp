...
TEST_CASE("SceneInspectorAPI moveObject undo restores both X and Y",
          "[scene_inspector][undo][moveObject]") {
  SceneGraph graph;
...
TEST_CASE("SceneInspectorAPI moveObject redo works correctly",
          "[scene_inspector][undo][moveObject][redo]") {
  SceneGraph graph;
  SceneInspectorAPI inspector(&graph);
...
TEST_CASE("SceneInspectorAPI multiple moves with undo chain",
          "[scene_inspector][undo][moveObject][chain]") {
  SceneGraph graph;
  SceneInspectorAPI inspector(&graph);
...
TEST_CASE("SceneInspectorAPI scaleObject undo restores both scaleX and scaleY",
          "[scene_inspector][undo][scaleObject]") {
  SceneGraph graph;
  SceneInspectorAPI inspector(&graph);
...
TEST_CASE("SceneInspectorAPI scaleObject redo works correctly",
          "[scene_inspector][undo][scaleObject][redo]") {
  SceneGraph graph;
  SceneInspectorAPI inspector(&graph);
...
TEST_CASE("SceneInspectorAPI multiple scales with undo chain",
          "[scene_inspector][undo][scaleObject][chain]") {
  SceneGraph graph;
  SceneInspectorAPI inspector(&graph);
...
TEST_CASE("CompositeCommand groups multiple commands", "[scene_inspector][composite]") {
  ...
  auto cmd1 = std::make_unique<SetPropertyCommand>(&inspector, "test_obj", "x", "0", "100");
  auto cmd2 = std::make_unique<SetPropertyCommand>(&inspector, "test_obj", "y", "0", "200");
